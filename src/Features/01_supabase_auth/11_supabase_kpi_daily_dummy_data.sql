-- Dummy data for Supabase/Postgres KPI daily tables
-- This data is intended for dashboard/demo only.

TRUNCATE TABLE public.inventory_kpi_daily RESTART IDENTITY;
TRUNCATE TABLE public.fleet_kpi_daily RESTART IDENTITY;

INSERT INTO public.inventory_kpi_daily (
...
INSERT INTO public.fleet_kpi_daily (
